...
const config = defineUserConfig<DefaultThemeOptions, ViteBundlerOptions>({
	...
	description: 'Imagina una guía... que explore las múltiples posibilidades de tu bot discord.js.',
	head: [
		['meta', { charset: 'utf-8' }],
		...
		['meta', { property: 'og:description', content: 'Imagina una guía... que explore las múltiples posibilidades de tu bot discord.js.' }],
